...
const FALLBACK_APK_URL = "https://github.com/qJulianx/FlowFlixWeb/releases";
...
export default function AndroidDownloadPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
      {/* Background accents */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-purple-500/20 blur-[100px] rounded-full -z-10" />
